...
Select the next increment only after P.42 lands on `main` and its feature branch is cleaned up. Do not restore or continue superseded P.36 managed-download work. Future work must be derived from the newest approved specification and an explicit customer decision.
